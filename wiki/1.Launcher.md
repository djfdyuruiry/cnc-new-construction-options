...
4. Extract all the files from the `.zip` or `.tar.gz` archive

5. Run the `NCO Launcher` file by double-clicking it

![Launcher Binary](img/launcher-file-explorer.png)

6. Go through the Installer Wizard to get everything setup

![Install Wizard](img/launcher-install-wizard.webp)
...
- Open a terminal (Use Windows Terminal/PowerShell on Windows)
  - Your file browser may allow you to open a terminal in the folder you have NCO Launcher in, try right-clicking and select 'Open in Terminal' (hold shift on Windows 10)
