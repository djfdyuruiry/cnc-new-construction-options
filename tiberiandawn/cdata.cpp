...
static TemplateTypeClass const
    Water2(TEMPLATE_WATER2, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "W2", TXT_WATER, LAND_WATER, 2, 2, LAND_WATER, NULL);
...
static TemplateTypeClass const
    Shore3(TEMPLATE_SHORE3, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "SH3", TXT_WATER, LAND_ROCK, 1, 1, LAND_WATER, NULL);
static TemplateTypeClass const
    Shore4(TEMPLATE_SHORE4, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "SH4", TXT_WATER, LAND_ROCK, 2, 1, LAND_WATER, NULL);
...
static TemplateTypeClass const Patch15(TEMPLATE_PATCH15,
                                       ...
                                       NULL);
static TemplateTypeClass const
    Patch16(TEMPLATE_PATCH16, THEATERF_WINTER | THEATERF_SNOW, "P16", TXT_PATCH, LAND_CLEAR, 2, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch17(TEMPLATE_PATCH17, THEATERF_WINTER | THEATERF_SNOW, "P17", TXT_PATCH, LAND_CLEAR, 4, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch18(TEMPLATE_PATCH18, THEATERF_WINTER | THEATERF_SNOW, "P18", TXT_PATCH, LAND_CLEAR, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch19(TEMPLATE_PATCH19, THEATERF_WINTER | THEATERF_SNOW, "P19", TXT_PATCH, LAND_CLEAR, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch20(TEMPLATE_PATCH20, THEATERF_WINTER | THEATERF_SNOW, "P20", TXT_PATCH, LAND_CLEAR, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const River1(TEMPLATE_RIVER1,
                                      ...
                                      NULL);
static TemplateTypeClass const
    River2(TEMPLATE_RIVER2, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV02", TXT_RIVER, LAND_WATER, 5, 3, LAND_ROCK, NULL);
static TemplateTypeClass const River3(TEMPLATE_RIVER3,
                                      ...
                                      (char const*)_slope00000001);
static TemplateTypeClass const
    River4(TEMPLATE_RIVER4, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV04", TXT_RIVER, LAND_WATER, 4, 4, LAND_ROCK, NULL);
static TemplateTypeClass const
    River5(TEMPLATE_RIVER5, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV05", TXT_RIVER, LAND_WATER, 3, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River6(TEMPLATE_RIVER6, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV06", TXT_RIVER, LAND_WATER, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    River7(TEMPLATE_RIVER7, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV07", TXT_RIVER, LAND_WATER, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    River8(TEMPLATE_RIVER8, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV08", TXT_RIVER, LAND_WATER, 2, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    River9(TEMPLATE_RIVER9, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV09", TXT_RIVER, LAND_WATER, 2, 2, LAND_ROCK, NULL);
