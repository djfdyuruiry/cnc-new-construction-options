...
static TemplateTypeClass const Empty(TEMPLATE_CLEAR1,
                                     THEATERF_WINTER | THEATERF_SNOW | THEATERF_DESERT | THEATERF_TEMPERATE | THEATERF_JUNGLE,
                                     "CLEAR1",
                                     "CLEAR1",
                                     TXT_CLEAR,
                                     LAND_CLEAR,
...
static TemplateTypeClass const Road1(TEMPLATE_ROAD1,
                                     THEATERF_WINTER | THEATERF_SNOW | THEATERF_DESERT | THEATERF_TEMPERATE,
                                     "D01",
                                     "D01",
                                     TXT_ROAD,
                                     LAND_CLEAR,
...
static TemplateTypeClass const
    Water2(TEMPLATE_WATER2, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "W2", "W2", TXT_WATER, LAND_WATER, 2, 2, LAND_WATER, NULL);
...
static TemplateTypeClass const
    Shore3(TEMPLATE_SHORE3, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "SH3", "SH3", TXT_WATER, LAND_ROCK, 1, 1, LAND_WATER, NULL);
static TemplateTypeClass const
    Shore4(TEMPLATE_SHORE4, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "SH4", "SH4", TXT_WATER, LAND_ROCK, 2, 1, LAND_WATER, NULL);
...
static TemplateTypeClass const Shore18(TEMPLATE_SHORE18,
                                       ...
                                       NULL);
static TemplateTypeClass const
    Shore19(TEMPLATE_SHORE19, THEATERF_DESERT, "SH19", "SH19", TXT_WATER, LAND_ROCK, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    Shore20(TEMPLATE_SHORE20, THEATERF_DESERT, "SH20", "SH20", TXT_WATER, LAND_ROCK, 4, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Shore21(TEMPLATE_SHORE21, THEATERF_DESERT, "SH21", "SH21", TXT_WATER, LAND_ROCK, 3, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Shore22(TEMPLATE_SHORE22, THEATERF_DESERT, "SH22", "SH22", TXT_WATER, LAND_ROCK, 6, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    Shore23(TEMPLATE_SHORE23, THEATERF_DESERT, "SH23", "SH23", TXT_WATER, LAND_ROCK, 2, 2, LAND_CLEAR, (char const*)_slope01);
...
static TemplateTypeClass const
    Shore25(TEMPLATE_SHORE25, THEATERF_DESERT, "SH25", "SH25", TXT_WATER, LAND_ROCK, 3, 2, LAND_CLEAR, (char const*)_slope0001);
static TemplateTypeClass const
    Shore26(TEMPLATE_SHORE26, THEATERF_DESERT, "SH26", "SH26", TXT_WATER, LAND_ROCK, 3, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore27(TEMPLATE_SHORE27, THEATERF_DESERT, "SH27", "SH27", TXT_WATER, LAND_ROCK, 4, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore28(TEMPLATE_SHORE28, THEATERF_DESERT, "SH28", "SH28", TXT_WATER, LAND_ROCK, 3, 1, LAND_CLEAR, NULL);
...
static TemplateTypeClass const
    Shore30(TEMPLATE_SHORE30, THEATERF_DESERT, "SH30", "SH30", TXT_WATER, LAND_ROCK, 2, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore31(TEMPLATE_SHORE31, THEATERF_DESERT, "SH31", "SH31", TXT_WATER, LAND_ROCK, 3, 3, LAND_CLEAR, NULL);
...
static TemplateTypeClass const
    Shore36(TEMPLATE_SHORE36, THEATERF_DESERT, "SH36", "SH36", TXT_WATER, LAND_CLEAR, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore37(TEMPLATE_SHORE37, THEATERF_DESERT, "SH37", "SH37", TXT_WATER, LAND_CLEAR, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore38(TEMPLATE_SHORE38, THEATERF_DESERT, "SH38", "SH38", TXT_WATER, LAND_CLEAR, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore39(TEMPLATE_SHORE39, THEATERF_DESERT, "SH39", "SH39", TXT_WATER, LAND_CLEAR, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore40(TEMPLATE_SHORE40, THEATERF_DESERT, "SH40", "SH40", TXT_WATER, LAND_WATER, 3, 3, LAND_CLEAR, (char const*)_slope1);
...
static TemplateTypeClass const
    Shore42(TEMPLATE_SHORE42, THEATERF_DESERT, "SH42", "SH42", TXT_WATER, LAND_WATER, 1, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore43(TEMPLATE_SHORE43, THEATERF_DESERT, "SH43", "SH43", TXT_WATER, LAND_WATER, 1, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore44(TEMPLATE_SHORE44, THEATERF_DESERT, "SH44", "SH44", TXT_WATER, LAND_WATER, 1, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore45(TEMPLATE_SHORE45, THEATERF_DESERT, "SH45", "SH45", TXT_WATER, LAND_WATER, 1, 2, LAND_CLEAR, NULL);
...
static TemplateTypeClass const
    Shore47(TEMPLATE_SHORE47, THEATERF_DESERT, "SH47", "SH47", TXT_WATER, LAND_WATER, 3, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore48(TEMPLATE_SHORE48, THEATERF_DESERT, "SH48", "SH48", TXT_WATER, LAND_WATER, 3, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore49(TEMPLATE_SHORE49, THEATERF_DESERT, "SH49", "SH49", TXT_WATER, LAND_WATER, 3, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const Shore50(TEMPLATE_SHORE50,
                                       ...
                                       (char const*)_slope00000001);
static TemplateTypeClass const
    Shore51(TEMPLATE_SHORE51, THEATERF_DESERT, "SH51", "SH51", TXT_WATER, LAND_WATER, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore52(TEMPLATE_SHORE52, THEATERF_DESERT, "SH52", "SH52", TXT_WATER, LAND_WATER, 4, 3, LAND_CLEAR, NULL);
...
static TemplateTypeClass const
    Shore54(TEMPLATE_SHORE54, THEATERF_DESERT, "SH54", "SH54", TXT_WATER, LAND_WATER, 3, 2, LAND_CLEAR, (char const*)_slope1);
static TemplateTypeClass const
    Shore55(TEMPLATE_SHORE55, THEATERF_DESERT, "SH55", "SH55", TXT_WATER, LAND_WATER, 3, 2, LAND_CLEAR, (char const*)_slope001);
static TemplateTypeClass const
    Shore56(TEMPLATE_SHORE56, THEATERF_DESERT, "SH56", "SH56", TXT_WATER, LAND_WATER, 3, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore57(TEMPLATE_SHORE57, THEATERF_DESERT, "SH57", "SH57", TXT_WATER, LAND_WATER, 3, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore58(TEMPLATE_SHORE58, THEATERF_DESERT, "SH58", "SH58", TXT_WATER, LAND_WATER, 2, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore59(TEMPLATE_SHORE59, THEATERF_DESERT, "SH59", "SH59", TXT_WATER, LAND_WATER, 2, 3, LAND_CLEAR, (char const*)_slope1);
...
static TemplateTypeClass const
    Shore61(TEMPLATE_SHORE61, THEATERF_DESERT, "SH61", "SH61", TXT_WATER, LAND_WATER, 2, 3, LAND_CLEAR, (char const*)_slope01);
static TemplateTypeClass const
    Shore62(TEMPLATE_SHORE62, THEATERF_DESERT, "SH62", "SH62", TXT_WATER, LAND_WATER, 6, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Shore63(TEMPLATE_SHORE63, THEATERF_DESERT, "SH63", "SH63", TXT_WATER, LAND_WATER, 4, 1, LAND_CLEAR, NULL);
...
static TemplateTypeClass const Boulder3(TEMPLATE_BOULDER3,
                                        ...
                                        NULL);
static TemplateTypeClass const
    Boulder4(TEMPLATE_BOULDER4, THEATERF_DESERT, "B4", "B4", TXT_SLOPE, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Boulder5(TEMPLATE_BOULDER5, THEATERF_DESERT, "B5", "B5", TXT_SLOPE, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Boulder6(TEMPLATE_BOULDER6, THEATERF_DESERT, "B6", "B6", TXT_SLOPE, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
...
static TemplateTypeClass const Slope38(TEMPLATE_SLOPE38,
                                       ...
                                       NULL);
static TemplateTypeClass const
    Brush1(TEMPLATE_BRUSH1, THEATERF_DESERT, "BR1", "BR1", TXT_BRUSH, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush2(TEMPLATE_BRUSH2, THEATERF_DESERT, "BR2", "BR2", TXT_BRUSH, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush3(TEMPLATE_BRUSH3, THEATERF_DESERT, "BR3", "BR3", TXT_BRUSH, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush4(TEMPLATE_BRUSH4, THEATERF_DESERT, "BR4", "BR4", TXT_BRUSH, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush5(TEMPLATE_BRUSH5, THEATERF_DESERT, "BR5", "BR5", TXT_BRUSH, LAND_ROCK, 1, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush6(TEMPLATE_BRUSH6, THEATERF_DESERT, "BR6", "BR6", TXT_BRUSH, LAND_ROCK, 2, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush7(TEMPLATE_BRUSH7, THEATERF_DESERT, "BR7", "BR7", TXT_BRUSH, LAND_ROCK, 2, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush8(TEMPLATE_BRUSH8, THEATERF_DESERT, "BR8", "BR8", TXT_BRUSH, LAND_ROCK, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush9(TEMPLATE_BRUSH9, THEATERF_DESERT, "BR9", "BR9", TXT_BRUSH, LAND_ROCK, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    Brush10(TEMPLATE_BRUSH10, THEATERF_DESERT, "BR10", "BR10", TXT_BRUSH, LAND_ROCK, 2, 1, LAND_ROCK, NULL);
static TemplateTypeClass const
    Patch1(TEMPLATE_PATCH1, THEATERF_TEMPERATE | THEATERF_DESERT, "P01", "P01", TXT_PATCH, LAND_CLEAR, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch2(TEMPLATE_PATCH2, THEATERF_TEMPERATE | THEATERF_DESERT, "P02", "P02", TXT_PATCH, LAND_ROCK, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch3(TEMPLATE_PATCH3, THEATERF_TEMPERATE | THEATERF_DESERT, "P03", "P03", TXT_PATCH, LAND_CLEAR, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch4(TEMPLATE_PATCH4, THEATERF_TEMPERATE | THEATERF_DESERT, "P04", "P04", TXT_PATCH, LAND_ROCK, 1, 1, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch5(TEMPLATE_PATCH5, THEATERF_DESERT, "P05", "P05", TXT_PATCH, LAND_CLEAR, 2, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch6(TEMPLATE_PATCH6, THEATERF_DESERT, "P06", "P06", TXT_PATCH, LAND_CLEAR, 6, 4, LAND_CLEAR, NULL);
...
static TemplateTypeClass const Patch15(TEMPLATE_PATCH15,
                                       ...
                                       NULL);
static TemplateTypeClass const
    Patch16(TEMPLATE_PATCH16, THEATERF_WINTER | THEATERF_SNOW, "P16", "P16", TXT_PATCH, LAND_CLEAR, 2, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch17(TEMPLATE_PATCH17, THEATERF_WINTER | THEATERF_SNOW, "P17", "P17", TXT_PATCH, LAND_CLEAR, 4, 2, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch18(TEMPLATE_PATCH18, THEATERF_WINTER | THEATERF_SNOW, "P18", "P18", TXT_PATCH, LAND_CLEAR, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch19(TEMPLATE_PATCH19, THEATERF_WINTER | THEATERF_SNOW, "P19", "P19", TXT_PATCH, LAND_CLEAR, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const
    Patch20(TEMPLATE_PATCH20, THEATERF_WINTER | THEATERF_SNOW, "P20", "P20", TXT_PATCH, LAND_CLEAR, 4, 3, LAND_CLEAR, NULL);
static TemplateTypeClass const River1(TEMPLATE_RIVER1,
                                      ...
                                      NULL);
static TemplateTypeClass const
    River2(TEMPLATE_RIVER2, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV02", "RV02", TXT_RIVER, LAND_WATER, 5, 3, LAND_ROCK, NULL);
static TemplateTypeClass const River3(TEMPLATE_RIVER3,
                                      ...
                                      (char const*)_slope00000001);
static TemplateTypeClass const
    River4(TEMPLATE_RIVER4, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV04", "RV04", TXT_RIVER, LAND_WATER, 4, 4, LAND_ROCK, NULL);
static TemplateTypeClass const
    River5(TEMPLATE_RIVER5, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV05", "RV05", TXT_RIVER, LAND_WATER, 3, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River6(TEMPLATE_RIVER6, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV06", "RV06", TXT_RIVER, LAND_WATER, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    River7(TEMPLATE_RIVER7, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV07", "RV07", TXT_RIVER, LAND_WATER, 3, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    River8(TEMPLATE_RIVER8, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV08", "RV08", TXT_RIVER, LAND_WATER, 2, 2, LAND_ROCK, NULL);
static TemplateTypeClass const
    River9(TEMPLATE_RIVER9, THEATERF_WINTER | THEATERF_SNOW | THEATERF_TEMPERATE, "RV09", "RV09", TXT_RIVER, LAND_WATER, 2, 2, LAND_ROCK, NULL);
...
static TemplateTypeClass const River13(TEMPLATE_RIVER13,
                                       ...
                                       NULL);
static TemplateTypeClass const
    River14(TEMPLATE_RIVER14, THEATERF_DESERT, "RV14", "RV14", TXT_RIVER, LAND_WATER, 4, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River15(TEMPLATE_RIVER15, THEATERF_DESERT, "RV15", "RV15", TXT_RIVER, LAND_WATER, 4, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River16(TEMPLATE_RIVER16, THEATERF_DESERT, "RV16", "RV16", TXT_RIVER, LAND_WATER, 6, 4, LAND_ROCK, NULL);
static TemplateTypeClass const
    River17(TEMPLATE_RIVER17, THEATERF_DESERT, "RV17", "RV17", TXT_RIVER, LAND_WATER, 6, 5, LAND_ROCK, NULL);
static TemplateTypeClass const
    River18(TEMPLATE_RIVER18, THEATERF_DESERT, "RV18", "RV18", TXT_RIVER, LAND_WATER, 4, 4, LAND_ROCK, NULL);
static TemplateTypeClass const
    River19(TEMPLATE_RIVER19, THEATERF_DESERT, "RV19", "RV19", TXT_RIVER, LAND_WATER, 4, 4, LAND_ROCK, NULL);
static TemplateTypeClass const
    River20(TEMPLATE_RIVER20, THEATERF_DESERT, "RV20", "RV20", TXT_RIVER, LAND_WATER, 6, 8, LAND_ROCK, NULL);
static TemplateTypeClass const
    River21(TEMPLATE_RIVER21, THEATERF_DESERT, "RV21", "RV21", TXT_RIVER, LAND_WATER, 5, 8, LAND_ROCK, NULL);
static TemplateTypeClass const
    River22(TEMPLATE_RIVER22, THEATERF_DESERT, "RV22", "RV22", TXT_RIVER, LAND_WATER, 3, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River23(TEMPLATE_RIVER23, THEATERF_DESERT, "RV23", "RV23", TXT_RIVER, LAND_WATER, 3, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River24(TEMPLATE_RIVER24, THEATERF_DESERT, "RV24", "RV24", TXT_RIVER, LAND_WATER, 3, 3, LAND_ROCK, NULL);
static TemplateTypeClass const
    River25(TEMPLATE_RIVER25, THEATERF_DESERT, "RV25", "RV25", TXT_RIVER, LAND_WATER, 3, 3, LAND_ROCK, NULL);
