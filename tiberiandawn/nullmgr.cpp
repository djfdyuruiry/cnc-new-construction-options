...
void NullModemClass::Set_Timing(unsigned int retrydelta, unsigned int maxretries, unsigned int timeout)
{
    // TODO: Fix
}

void NullModemClass::Configure_Debug(int index,
                                     int type_offset,
                                     int type_size,
                                     const char** names,
                                     int namestart,
 ...
 *=========================================================================*/
void NullModemClass::Configure_Debug(int index, int offset, int size, const char **names, int maxnames)
{
	if (Connection)
		Connection->Queue->Configure_Debug(offset, size, names, 0, maxnames);
}
